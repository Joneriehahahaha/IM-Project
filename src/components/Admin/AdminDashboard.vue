...
<template>
  ...
  <v-dialog v-model="editAccouncementDialog" width="80%">
        <v-card title="Edit announcement">
            ...
            <v-card-actions>
                <v-spacer/>
                <v-btn color="black" @click="editAccouncementDialog = false">Cancel</v-btn>
                <v-btn color="black" @click="updateAnnouncement()" :loading="loading">Update</v-btn>
            </v-card-actions>
        </v-card>
    </v-dialog>
    ...
    <v-dialog v-model="deleteAccouncementDialog" width="80%">
        <v-card title="Delete announcement">
            ...
            <v-card-actions>
                <v-spacer/>
                <v-btn color="black" @click="deleteAccouncementDialog = false">Cancel</v-btn>
